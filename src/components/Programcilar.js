...
export default function Programcilar() {
  ...
  const [programciListe, setProgramciListe] = useState(enIyilerListesi);
  ...
  if (programciId) {
    return programciListe.find(programci => programci.id === programciId).isim
  } else {
    return "";
  };
  };
